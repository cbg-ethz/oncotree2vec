...
def get_clusters_from_hierarchy_linkage(hierarchy_linkage, labels, distance_threshold=1):
  ...
  cluster_ids = list(hierarchy.fcluster(hierarchy_linkage, distance_threshold, criterion='distance'))
...
def get_similarity_clusters(hierarchy_linkage, labels, df_distances, distance_threshold=1):
...
def get_labeling(anytrees, node_label_map, distance_threshold, label_start_id=2, plot_statistic=False):
  ...
  node_clusters = get_similarity_clusters(clustering, nodes, df_distances, distance_threshold)
