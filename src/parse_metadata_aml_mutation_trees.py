...
def parse_metadata_aml_mutation_trees(samples):
  ...
  metadata = pd.read_csv("../data/aml-mutation-trees/metadata_aml_mutation_trees.csv", sep = ',').fillna("").applymap(str)
  ...
  metadata_colors['untreated'] = {'treated': '#cdbfcf', 'RR': '#e1d48e', 'untreated': '#7b9a4a'}
  metadata_colors['Gender'] = {'Female': "#cc3b2e", 'Male': "#a0c0dd"}
  metadata_colors['VitalStatus'] = {'Dead NOS': '#3d3b48', 'Alive NOS': '#f9cb9c'}
  metadata_colors['age'] = {10: "#f5f5f0", 20:"#e0e0d2", 30:"#cbcbb3", 40:"#b6b695", 50:"#a2a277", 60:"#88885d", 70:"#6a6a49", 80:"#4c4c34"}
  metadata_colors['Diagnosis'] = {'AEL': '#cdbfcf', 'AML': '#e1d48e', 'AMOL': '#d8b74b', 'AMML': '#008080', 'AUL': '#014421'}
  metadata_colors['Tx_group'] = {'others': '#cdbfcf', 'IA-based': '#e1d48e', 'DAC_VEN': '#d8b74b', 'HMA': '#008080', 'AraC-based': '#014421'} 
